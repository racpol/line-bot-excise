...
$ACCESS_TOKEN = 'ju6MpAoy0yBG+JdGIJ/Ha/ECbO8mniDt6aiUp6fcTX5w2v9H6+Bb9XD2W3v8wyodqgEToljLFnywEaN/ZaZJYpxRotSp2MfGCtJnDzFhl5pMHDoQ4kIgeH6LNLnRir6Gzd54zMXLpNMPc2at39glXgdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	   ...
	   if($text == "ใบอนุญาตขายสุราของฉันหมดอายุวันไหน"){
           ...
           if($text == "อุณหภูมิตอนนี้" || $text == "อุณหภูมิขณะนี้" || $text == "อุณหภูมิตอนนี้กี่องศา"  ){
